if (function(t, e) {
    ...
    function I(t, e, i, n) {
        ...
        if (d && (u = v(e, t[0].ownerDocument, !1, t, n), o = u.firstChild, 1 === u.childNodes.length && (u = o), o || n)) {
            ...
            if (s)
                for (l = a[a.length - 1].ownerDocument, ht.map(a, _), c = 0; s > c; c++) r = a[c], Ft.test(r.type || "") && !ht._data(r, "globalEval") && ht.contains(l, r) && (r.src ? ht._evalUrl && ht._evalUrl(r.src) : ht.globalEval((r.text || r.textContent || r.innerHTML || "").replace(ne, "")));
            u = o = null
        }
        return t
    }
                    ...
                    return 1 === n && 0 === o ? function(t) {
                        ...
                        if (g) {
                            ...
                            if (f = [s ? g.firstChild : g.lastChild], s && y) {
                                for (w = (p = (u = (c = (d = (h = g)[M] || (h[M] = {}))[h.uniqueID] || (d[h.uniqueID] = {}))[t] || [])[0] === R && u[1]) && u[2], h = p && g.childNodes[p]; h = ++p && h && h[m] || (w = p = 0) || f.pop();)
                                    if (1 === h.nodeType && ++w && h === e) {
                                        c[t] = [R, p, w];
                                        break
                                    }
                            } else if (y && (h = e, d = h[M] || (h[M] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), u = c[t] || [], p = u[0] === R && u[1], w = p), !1 === w)
                                for (;
                                    (h = ++p && h && h[m] || (w = p = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++w || (y && (d = h[M] || (h[M] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), c[t] = [R, w]), h !== e)););
    ...
    ht.event = {
        ...
        trigger: function(e, i, n, o) {
            ...
            if (a = c = n = n || it, 3 !== n.nodeType && 8 !== n.nodeType && !Vt.test(p + ht.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), s = p.indexOf(":") < 0 && "on" + p, e = e[ht.expando] ? e : new ht.Event(p, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : ht.makeArray(i, [e]), u = ht.event.special[p] || {}, o || !u.trigger || !1 !== u.trigger.apply(n, i))) {
                ...
                for (d = 0;
                    (a = h[d++]) && !e.isPropagationStopped();) e.type = d > 1 ? l : u.bindType || p, (r = (ht._data(a, "events") || {})[e.type] && ht._data(a, "handle")) && r.apply(a, i), (r = s && a[s]) && r.apply && Ot(a) && (e.result = r.apply(a, i), !1 === e.result && e.preventDefault());
    ...
    ht.Animation = ht.extend(H, {
            ...
            prefilters: [function(t, e, i) {
                ...
                if (ht.isEmptyObject(d)) "inline" === ("none" === u ? O(t.nodeName) : u) && (h.display = u);
                else {
    ...
    ht.fn.extend({
        ...
        removeAttr: function(t, e) {
            var i, n, o = 0,
                r = e && e.match(It);
            if (r && 1 === t.nodeType)
                for (; i = r[o++];) n = ht.propFix[i] || i, ht.expr.match.bool.test(i) ? Ne && Le || !De.test(i) ? t[n] = !1 : t[ht.camelCase("default-" + i)] = t[n] = !1 : ht.attr(t, i, ""), t.removeAttribute(Le ? i : n)
        }
    }), Ae = {
        set: function(t, e, i) {
    ...
    return function(t, e, i, n) {
        ...
        o.extend(s, n);
        var a, l, u, c, d, h, p, f, m, g, v, y, w, b, x, C, T, _, E, S, I, k, A, O, D, L, N, $, P, z, M, j, R, F, W, H, q, B, U, Z, Q, X, V, Y, G, K, J, tt, et, it, nt, ot, rt, st, at, lt, ut, ct = {
                x: 0,
                y: 0
            },
            dt = {
            ...
            je = function(t) {
                ...
                var c = -1;
                if (0 === u && (U = !1, o.unbind(window, p, r), be(), K ? c = 0 : -1 !== pe && (c = It() - pe)), pe = 1 === u ? It() : -1, a = -1 !== c && c < 150 ? "zoom" : "swipe", K && u < 2 && (K = !1, 1 === u && (a = "zoomPointerUp"), St("zoomGestureEnded")), G = null, X || Q || nt || q)
